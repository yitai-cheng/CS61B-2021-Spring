...
public class CapersRepository {
    ...
    public static void writeStory(String text) {
        if (Utils.join(CAPERS_FOLDER, "story.txt").length() == 0) {
            Utils.writeContents(Utils.join(CAPERS_FOLDER, "story.txt"), text);
        }
        else {
            Utils.writeContents(Utils.join(CAPERS_FOLDER, "story.txt"), Utils.readContentsAsString(Utils.join(CAPERS_FOLDER, "story.txt")), "\n", text);
        }
